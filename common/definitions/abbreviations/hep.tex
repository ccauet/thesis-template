...
\newcommand{\RunTwo}{Run II}

\newcommand{\BFactory}{$\B$ factory}
\newcommand{\BFactories}{$\B$ factories}
\newcommand{\Babar}{\textsc{BaBar}}
\newcommand{\Belle}{Belle}
\newcommand{\BelleTwo}{Belle II}

%% Analysis techniques
\newcommand{\sweight}{sWeight}
\newcommand{\sweights}{sWeights}
\newcommand{\sWeights}{\sweights}
\newcommand{\sweighted}{sWeighted}
...
\newmathsymbol{\sintwobetabfsf}{\text{\textbf{sin}}\mathbfsf{(2\beta)}}
