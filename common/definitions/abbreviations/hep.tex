...
%% Efficiencies
\newmathsymbol{\SigEff}{\varepsilon_{\Sig}\xspace}
\newmathsymbol{\BkgEff}{\varepsilon_{\Bkg}\xspace}
\newmathsymbol{\BkgRej}{1-\varepsilon_{\Bkg}\xspace}

%% Uncertainties
\newmathsymbol{\stat}{\text{stat}\xspace}
\newmathsymbol{\syst}{\text{syst}\xspace}
\newmathsymbol{\statp}{\text{\,(stat)}\xspace}
\newmathsymbol{\systp}{\text{\,(syst)}\xspace}
...
\newmathsymbol{\MixingAsymmetry}{\mathcal{A}_{\text{Mix}}\xspace}
