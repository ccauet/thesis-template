...
\newcommand{\sFit}{sFit\xspace}
\newcommand{\sfit}{\sFit}
\newcommand{\sFits}{sFits\xspace}
\newcommand{\sfits}{\sFits}
...
%% Hamiltonian
\newcommand{\Hamiltonian}[2]{\ensuremath{{H}_{#1}^{#2}}}
...
\newmathsymbol{\LL}{\ln\mathcal{L}}
\newmathsymbol{\DLL}{\Delta\LL}
...
\newmathsymbol{\DLLpK}{\DLL_{\proton\kaon}}
\newmathsymbol{\DLLKp}{\DLL_{\kaon\proton}}
...
\newmathsymbol{\sintwobetabfsf}         {\textbf{sin(}\mathbfsf{2\beta}\textbf{)}}
\newmathsymbol{\sintwobetait}           {\textrm{sin(2}\beta\textrm{)}}
\newmathsymbol{\sintwobetabfsfHyperref} {\texorpdfstring{\textbf{sin(}\mathbfsf{2\beta}\textbf{)}}{sin(2β)}}
...
\newcommand{\ketinl}[1]         {\ensuremath{\vert #1 \rangle}}
