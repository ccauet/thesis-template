...
\newcommand{\RecoFourteen}   {\UseVerb{tmp_recofourteen}\xspace}

\newmathsymbol{\dtf}         {\text{\acs*{DTF}}_{\acs*{PV}}^{\jpsi\KS}\xspace}
\newmathsymbol{\dtfpv}       {\text{\acs*{DTF}}_{\acs*{PV}}\xspace}